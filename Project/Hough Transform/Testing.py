...
image2 = cv.imread('Image_After_Hysteresis_Thresholding.jpg')
...
(acc, rhos, thetas) = line_detection_non_vectorized(
    image, image2, num_rhos=180, num_thetas=180, t_count=220)
